...
import SearchInput from "@/app/(dashboard)/accounts/accounts/banking/components/SearchInput";
import BankAccountList from "@/app/(dashboard)/accounts/accounts/banking/components/BankAccountList";
import TransactionList from "@/app/(dashboard)/accounts/accounts/banking/components/TransactionList";
import ReconciliationView from "@/app/(dashboard)/accounts/accounts/banking/components/ReconciliationView";
import PaymentModal from "@/app/(dashboard)/accounts/accounts/banking/components/PaymentModal";
import TransactionDetails from "@/app/(dashboard)/accounts/accounts/banking/components/TransactionDetails";
import BankAccountDetails from "@/app/(dashboard)/accounts/accounts/banking/components/BankAccountDetails";
            ...
            <div className="w-full md:w-2/3 bg-white rounded-lg shadow-lg p-6">
                {isInitiatingPayment ? (
                    ...
                    <BankAccountDetails
                        ...
                        onEdit={() => router.push('/accounts/banking/connect-manually')}
