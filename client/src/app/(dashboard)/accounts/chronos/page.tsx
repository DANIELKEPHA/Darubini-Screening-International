...
import Header from "@/app/(dashboard)/accounts/chronos/components/attendance/Header";
import AttendanceControls from "@/app/(dashboard)/accounts/chronos/components/attendance/AttendanceControls";
import AttendanceDisplay from "@/app/(dashboard)/accounts/chronos/components/attendance/AttendanceDisplay";
