...
import ConfirmDialog from "@/app/(dashboard)/accounts/client-expenses/components/ConfirmDialog";
import ApprovePaymentModal from "@/app/(dashboard)/accounts/client-expenses/components/ApprovePaymentModal";
...
export default function ClientExpenseDetails({
    ...
    const handleEditConfirm = async () => {
        ...
        closeEditConfirm();
        router.push(`/accounts/client-expenses/components/${expense.id}/edit`);
    };
