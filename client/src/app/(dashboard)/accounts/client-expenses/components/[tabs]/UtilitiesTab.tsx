...
export default function UtilitiesTab() {
    ...
    const accountTypes = [
        ...
        },
        {
            id: 'mobile-money',
            label: 'Mobile Money',
            path: '/accounts/accounts/mobile-money',
            icon: Smartphone,
    ...
    const utilities = [
        ...
        },
        {
            label: 'Invoices',
            icon: Receipt,
            path: '/accounts/client-expenses/components/invoices',
