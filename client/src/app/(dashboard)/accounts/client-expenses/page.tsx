...
import ClientExpenseForm from "@/app/(dashboard)/accounts/client-expenses/components/ClientExpenseForm";
import SearchInput from "@/app/(dashboard)/accounts/client-expenses/components/SearchInput";
import UtilitiesTab from "@/app/(dashboard)/accounts/client-expenses/components/[tabs]/UtilitiesTab";
import ClientExpenseList, {
    ClientExpenseListProps
} from "@/app/(dashboard)/accounts/client-expenses/components/ClientExpenseList";
import ClientExpenseDetails from "@/app/(dashboard)/accounts/client-expenses/components/ClientExpenseDetails";
...
useEffect(() => {
    if (expenseId && expenseFromUrl) {
        ...
        setIsCreating(false);
        router.replace("/accounts/client-expenses", { scroll: false });
    }
...
// ✅ FIX: handle pagination + selection properly
