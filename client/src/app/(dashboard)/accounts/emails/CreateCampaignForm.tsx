...
import EmailEditor from "@/app/(dashboard)/accounts/emails/EmailEditor";
...
const defaultFooter = `
    ...
    <div style="text-align: center; font-family: Arial, sans-serif; font-size: 12px; color: #555555; line-height: 1.6; max-width: 600px; margin: 0 auto; background-color: #f5f5f5; padding: 10px; border-radius: 4px;" contenteditable="false">
        ...
        <p><a href="mailto:support@darubiniscreening.com">support@darubiniscreening.com</a> | <a href="https://darubiniscreening.com">darubiniscreening.com</a></p>
