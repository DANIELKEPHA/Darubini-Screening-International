...
import Header from "@/app/(dashboard)/admin/chronos/components/attendance/Header";
import AttendanceControls from "@/app/(dashboard)/admin/chronos/components/attendance/AttendanceControls";
import AttendanceDisplay from "@/app/(dashboard)/admin/chronos/components/attendance/AttendanceDisplay";
