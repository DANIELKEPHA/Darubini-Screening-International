...
const ManagerSettings = () => {
    ...
    const { isSignUpEnabled, isLoading: isSignUpLoading, isUpdating: isSignUpUpdating, toggleSignUp } = useSignUpSettings(false);
    ...
    const onSubmit = async (data: SettingsFormData) => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/admin/${authUser.cognitoInfo.userId}`, {
                method: "PUT",
                    ...
                    >
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-gray-900">{authUser.userInfo?.name || "Admin User"}</h2>
                        ...
                        >
                            ...
                            >
                                <motion.div
                                    ...
                                    className="h-full"
                                >
                                    <Card className="h-full bg-gradient-to-br from-white to-gray-50 border border-gray-200 shadow-lg rounded-2xl overflow-hidden">
                                                    ...
                                                    <div className="space-y-4">
                                                        <div>
                                                            ...
                                                            {form.formState.errors.phoneNumber && (
                                                                <p className="text-sm text-red-500 mt-2">{form.formState.errors.phoneNumber.message}</p>
                                                            )}
                                                        </div>
                                                    </div>
