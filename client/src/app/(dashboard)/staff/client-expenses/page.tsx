...
import ClientExpenseForm from "@/app/(dashboard)/staff/client-expenses/components/ClientExpenseForm";
import SearchInput from "@/app/(dashboard)/staff/client-expenses/components/SearchInput";
import UtilitiesTab from "@/app/(dashboard)/staff/client-expenses/components/[tabs]/UtilitiesTab";
import ClientExpenseList, {
    ClientExpenseListProps
} from "@/app/(dashboard)/staff/client-expenses/components/ClientExpenseList";
import ClientExpenseDetails from "@/app/(dashboard)/staff/client-expenses/components/ClientExpenseDetails";
...
export default function ClientExpensesPage() {
    ...
    useEffect(() => {
        if (expenseId && expenseFromUrl) {
            ...
            setIsCreating(false);
            router.replace("/staff/client-expenses", { scroll: false });
        }
