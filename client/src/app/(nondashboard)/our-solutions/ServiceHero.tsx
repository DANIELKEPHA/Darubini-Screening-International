        ...
        <section className="relative bg-gradient-to-br from-primary-700 to-primary-800 py-24 overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-6">
                <div className="max-w-6xl mx-auto">
                    <motion.div variants={container} initial="hidden" animate="show" className="text-center mb-16">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-secondary-400 to-white">
                Advanced Employee Vetting
                        ...
                        >
                            Darubini Screening delivers comprehensive, compliant background verification services that help
                            organizations mitigate risk and build trustworthy teams.
                        </motion.p>
                        ...
                        <motion.div variants={item} className="flex flex-col sm:flex-row justify-center gap-4">
                            ...
                            <motion.button
                                ...
                                className="px-8 py-4 bg-secondary-500 hover:bg-secondary-600 text-white font-medium rounded-lg transition-all duration-300 shadow-lg flex items-center justify-center gap-2 h-14 text-lg font-geist"
                            >
